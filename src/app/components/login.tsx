...
//           Stay Organized,
//           <span className="block mt-2 bg-gradient-to-r from-purple-400 to-[#A594F9] bg-clip-text text-transparent">
//             Be Productive
//           </span>
//         </h1>
...
//               key={label}
//               className="text-center">
//               <h3 className="text-2xl md:text-3xl font-bold text-[#A594F9]">
//                 {stat}
//               </h3>
//               <p className="text-sm text-gray-400">{label}</p>
//             </div>
