...
export async function GET(request: Request) {
  try {
    ...
    const parsedTodos = todos.map((todo) => ({
      ...todo,
      tags: JSON.parse(typeof todo.tags === "string" ? todo.tags : "[]"),
    }));
...
export async function POST(request: Request) {
  try {
    ...
    newTodo.tags = JSON.parse(
      typeof newTodo.tags === "string" ? newTodo.tags : "[]"
    );
...
export async function PATCH(request: Request) {
  try {
    ...
    updatedTodo.tags = JSON.parse(
      typeof updatedTodo.tags === "string" ? updatedTodo.tags : "[]"
    );
