					...
					todos.map((todo, index) => {
						...
						return (
							<React.Fragment key={todo.id}>
								{/* Separator */}
								{index > 0 && <div className="border-b border-primary mx-2" />}
...
// 			<div
// 				className={`flex-1 overflow-y-auto ${
// 					showCollapsed ? "p-1 space-y-1" : "p-2 space-y-1"
// 				}`}
// 			>
// 				{todos.length === 0 && !showCollapsed ? (
// 					<div className="text-center p-10 text-muted-foreground">
...
// 													key={tag}
// 													variant="secondary"
// 													className="text-xs cursor-pointer bg-primary/20 hover:bg-primary/40 transition-colors"
// 													onClick={(e) => {
// 														e.stopPropagation();
// 														onTagSelect(tag);
// 													}}
